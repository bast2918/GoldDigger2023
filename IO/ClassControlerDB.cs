...
namespace IO
{
    public class ClassControlerDB : ClassDbCon
    {
        ...
        public List<ClassProduct> GetAllProductsFromDB()
        {
            ...
            List<ClassApiResponse> apiResponds = MimicAPI();
        ...
        public List<ClassApiResponse> MimicAPI()
        {
            // makes containers
            List<ClassApiResponse> res = new List<ClassApiResponse>();
